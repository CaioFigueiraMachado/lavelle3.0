...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01-Dez-2025 às 00:24
...
--
-- Estrutura da tabela `contato_mensagens`
--
...
--
-- Extraindo dados da tabela `contato_mensagens`
--

INSERT INTO `contato_mensagens` (`id`, `usuario_id`, `assunto`, `mensagem`, `status`, `prioridade`, `created_at`, `updated_at`) VALUES
(2, 2, 'Dúvida sobre produtos', 'olá, preciso de ajuda sobre o tamanho dos perfumes', 'respondida', 'media', '2025-11-28 14:27:00', '2025-11-28 14:35:17'),
(3, 2, 'Outro', 'meu problema seria que todos são', 'fechada', 'media', '2025-11-28 14:36:33', '2025-11-28 14:44:18'),
(4, 2, 'Dúvida sobre produtos', 'dasdlasdasdlásdasdp´sadád´´adsa', 'respondida', 'media', '2025-11-28 15:14:12', '2025-11-28 15:31:51'),
(5, 2, 'Dúvida sobre produtos', 'oioioioiiooioiioioiooioi', 'fechada', 'media', '2025-11-28 15:32:20', '2025-11-28 15:32:36'),
(6, 2, 'Dúvida sobre produtos', 'me ajude droga', 'respondida', 'media', '2025-11-29 23:44:33', '2025-11-29 23:44:56');

-- --------------------------------------------------------

--
-- Estrutura da tabela `contato_respostas`
--

CREATE TABLE `contato_respostas` (
  `id` int(11) NOT NULL,
...
--
-- Extraindo dados da tabela `contato_respostas`
--

INSERT INTO `contato_respostas` (`id`, `mensagem_id`, `remetente`, `mensagem`, `lida`, `created_at`) VALUES
(5, 2, 'cliente', 'olá, preciso de ajuda sobre o tamanho dos perfumes', 1, '2025-11-28 14:27:00'),
(6, 2, 'admin', 'olá, a duvida seria qual?', 1, '2025-11-28 14:35:17'),
(7, 3, 'cliente', 'meu problema seria que todos são', 1, '2025-11-28 14:36:33'),
(8, 3, 'admin', 'são oque?', 1, '2025-11-28 14:36:55'),
(9, 4, 'cliente', 'dasdlasdasdlásdasdp´sadád´´adsa', 1, '2025-11-28 15:14:12'),
(10, 4, 'admin', 'olá', 1, '2025-11-28 15:14:28'),
(11, 4, 'admin', 'tranquilo?', 1, '2025-11-28 15:31:17'),
(12, 4, 'cliente', 'sim e voce', 1, '2025-11-28 15:31:30'),
(13, 4, 'admin', 'tudo bem também', 1, '2025-11-28 15:31:51'),
(14, 5, 'cliente', 'oioioioiiooioiioioiooioi', 1, '2025-11-28 15:32:20'),
(15, 6, 'cliente', 'me ajude droga', 1, '2025-11-29 23:44:33'),
(16, 6, 'cliente', 'olá', 1, '2025-11-29 23:44:40'),
(17, 6, 'admin', 'olá', 1, '2025-11-29 23:44:56');
...
(19, 2, '2025-11-24 15:52:37', 299.99, 'confirmado', 'pix', 'Rua Essio Lanfredi, 1 - Parque Residencial Maria Elmira - Caçapava/SP - CEP: 12285-010', '2025-11-24 18:52:37'),
(20, 2, '2025-11-29 20:48:04', 289.99, 'confirmado', 'pix', 'Rua Essio Lanfredi, 12 - Parque Residencial Maria Elmira - Caçapava/SP - CEP: 12285-010', '2025-11-29 23:48:04'),
(21, 2, '2025-11-30 20:01:23', 289.99, 'confirmado', 'cartao_credito', 'Rua Essio Lanfredi, 1 - Parque Residencial Maria Elmira - Caçapava/SP - CEP: 12285-010', '2025-11-30 23:01:23'),
(22, 2, '2025-11-30 20:06:07', 399.99, 'enviado', 'boleto', 'Rua Essio Lanfredi, 1 - Parque Residencial Maria Elmira - Caçapava/SP - CEP: 12285-010', '2025-11-30 23:06:07'),
(23, 2, '2025-11-30 20:16:20', 289.99, 'confirmado', 'boleto', 'Rua Essio Lanfredi, 1 - Parque Residencial Maria Elmira - Caçapava/SP - CEP: 12285-010', '2025-11-30 23:16:20'),
(24, 2, '2025-11-30 20:23:50', 289.99, 'pendente', 'boleto', 'Rua Essio Lanfredi, 1 - Parque Residencial Maria Elmira - Caçapava/SP - CEP: 12285-010', '2025-11-30 23:23:50');
...
(10, 19, 'confirmado', 'Pedido confirmado.', '2025-11-24 18:55:27', 2);
...
(23, 19, 69, 1, 299.99, 299.99),
(24, 20, 68, 1, 289.99, 289.99),
(25, 21, 68, 1, 289.99, 289.99),
(26, 22, 67, 1, 399.99, 399.99),
(27, 23, 68, 1, 289.99, 289.99),
(28, 24, 68, 1, 289.99, 289.99);
...
(50, 'Lavelle Amour', NULL, 'A delicadeza e a paixão da rosa em uma fragrância feminina e envolvente, com um toque de sofisticação', 'Lavelle Amour é a celebração da feminilidade e da beleza atemporal da rosa. O frasco, com seu design elegante e clássico, revela um líquido de tonalidade rosada suave, complementado por detalhes em ouro rosé, transmitindo uma sensação de delicadeza e requinte.', 279.90, 'img/Lavelle Rose Sublime.jpg', '2025-11-10 13:03:27', '2025-11-30 22:50:03', 'Feminino', 'Pêra, Lichia, Bergamota', 'Rosa Damascena, Peônia, Jasmim', 'Baunilha, Almíscar Branco, Cedro'),
...
(57, 'Lavelle Woodline King', NULL, 'Dominação amadeirada. Cheiro de liderança.', 'Sândalo, cedro, tabaco suave e âmbar formam um acorde robusto e luxuoso. A intensidade é equilibrada com notas de limão siciliano e pimenta branca. Perfume de personalidade forte.', 339.99, 'img/Lavelle Woodline King.png', '2025-11-14 13:23:20', '2025-11-24 19:13:18', 'Masculino', 'Limão Siciliano, Pimenta Branca', 'Tabaco Suave', 'Sândalo, Cedro, Âmbar'),
...
(69, 'Lavelle Espírito Livre', NULL, 'A essência da liberdade e do ar puro. Lavelle Espírito Livre é uma fragrância aquática, fresca.', 'Lavelle Espírito Livre é um convite para respirar fundo no topo do mundo. Esta fragrância é uma ode à liberdade sem limites e à serenidade da natureza. Começa com a explosão revigorante da Bergamota Gelada, misturada a um inebriante Acorde de Névoa do Mar que limpa a mente.', 299.99, 'img/Lavelle Espírito Livre.png', '2025-11-14 16:55:32', '2025-11-24 18:59:53', 'Feminino', 'Acorde de Névoa do Mar, Bergamota Gelada, Folhas de Violeta', 'Flor de Lótus, Ozônio, Chá Branco', 'Madeira Flutuante, Almíscar Branco, Ambroxan');
...
(2, 'ADM LAVELLE PERFUMES', 'admlavelle@gmail.com', '$2y$10$kImXpMcxoT3ysLvVG3Pj5O4wZPwzYrAJfbnfLjcP6D4TP87Xfom4m', '2025-10-31 11:56:05', '(12) 99733-3349', 'Rua Essio Lanfredi, 1 - Parque Residencial Maria Elmira', 'Caçapava', 'SP', '12285-010', 'uploads/perfis/perfil_2_1764459849.jpg', '2025-10-31 12:13:07'),
...
--
-- Índices para tabela `contato_mensagens`
--
...
--
-- Índices para tabela `contato_respostas`
--
ALTER TABLE `contato_respostas`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de tabela `contato_respostas`
--
ALTER TABLE `contato_respostas`
...
--
-- Limitadores para a tabela `contato_mensagens`
--
ALTER TABLE `contato_mensagens`
  ADD CONSTRAINT `contato_mensagens_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Limitadores para a tabela `contato_respostas`
--
ALTER TABLE `contato_respostas`
  ADD CONSTRAINT `contato_respostas_ibfk_1` FOREIGN KEY (`mensagem_id`) REFERENCES `contato_mensagens` (`id`) ON DELETE CASCADE;
