...
<head>
    ...
    <title>Comprovante do Pedido #028</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="comprovante">
        <div class="header">
            ...
            <div class="numero-pedido">Pedido #028</div>
        ...
        <div class="info-grid">
            <div class="info-section">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">01/12/2025 12:06</div>
                </div>
                <div class="info-item">
            ...
            <div class="info-section">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">Pietro</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Email:</div>
                    <div class="info-value">pietro@gmail.com</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Telefone:</div>
                    <div class="info-value">(12) 35262-46929</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Endereço:</div>
                    <div class="info-value">Rua Benedito Oberdan Fernandes Lobo, 1 - Casa - Residencial Portal da Mantiqueira</div>
                </div>
            </div>
        </div>
        ...
        <div class="total-section">
            <div class="total-line">
                <strong>Total do Pedido: R$ 299,90</strong>
            </div>
        </div>
        ...
        <div class="footer">
            <p>Comprovante gerado automaticamente em 01/12/2025 às 16:10</p>
