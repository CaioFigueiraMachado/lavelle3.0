...
<head>
    ...
    <title>Comprovante do Pedido #021</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="comprovante">
        <div class="header">
            ...
            <div class="numero-pedido">Pedido #021</div>
        ...
        <div class="info-grid">
            <div class="info-section">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">30/11/2025 20:01</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Método de Pagamento:</div>
                    <div class="info-value">Cartao_credito</div>
                </div>
                <div class="info-item">
        ...
        <div class="total-section">
            <div class="total-line">
                <strong>Total do Pedido: R$ 289,99</strong>
            </div>
        </div>
        ...
        <div class="footer">
            <p>Comprovante gerado automaticamente em 01/12/2025 às 00:19</p>
